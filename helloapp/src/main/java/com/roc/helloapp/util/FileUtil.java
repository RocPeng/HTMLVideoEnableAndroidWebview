...
public final class FileUtil {
	...
	/***
	 * 将accsets的文件拷贝到文件的安装目录
	 * 
	 * @param cxt
	 * @param fileName
	 * @return
	 */
	public static boolean copyAssetsFileToLocal(Context cxt, String fileName) {
	 ...
	 * 从assets获取图片
	 */
	public static Bitmap getImageFromAssetsFile(Context cxt, String fileName) {
		Bitmap image = null;
	...
	public static String getFileExtension(String filePath) {
		...
		if ((filePath != null) && (filePath.length() > 0)) {
			...
			if ((dot > -1) && (dot < (filePath.length() - 1))) {
				fileTypeString = filePath.substring(dot + 1);
			}
		}
	...
	/**
	 * 根据不同文件拓展名返回不同icon resId
	 */
	public static int getFileIconResId(String fileExtension) {
